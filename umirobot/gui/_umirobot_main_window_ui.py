...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkbox_communication_arduino = QtWidgets.QCheckBox(self.frame_10)
        self.checkbox_communication_arduino.setText("")
        self.checkbox_communication_arduino.setChecked(True)
        self.checkbox_communication_arduino.setObjectName("checkbox_communication_arduino")
        self.horizontalLayout_6.addWidget(self.checkbox_communication_arduino)
        ...
        self.gridLayout_9.addWidget(self.frame_10, 1, 0, 2, 2)
        spacerItem19 = QtWidgets.QSpacerItem(20, 22, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_9.addItem(spacerItem19, 3, 0, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.textedit_status, 2, 2, 1, 1)
        spacerItem20 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_9.addItem(spacerItem20, 3, 1, 1, 1)
